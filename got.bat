...
java -Xmx6072m -Xss10M -XX:MaxJavaStackTraceDepth=-1 -XX:+TieredCompilation -XX:TieredStopAtLevel=1 -Xverify:none -cp ";%GOT_HOME%;%GOT_HOME%lib\frege3.24-7.100.jar" frege.compiler.Main -target 1.7 -d %BUILD% %GOT_HOME%src\Gottlob.fr
